...
COPY hello.c /app
ENTRYPOINT whoami; ls -lag /; find /mnt; dd if=/dev/zero of=/mnt/hello/testfile bs=10M count=4000 oflag=direct; cd app; make hello; while [ 1 ]; do ./hello; sleep 60; done
